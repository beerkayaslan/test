	...
	_createClass(Contents, [{
  	...
  	*/
		...
		value: function css(property, value, priority) {
            ...
            return document.defaultView.getComputedStyle(content)[property];
		}
...
var Themes = function () {
  ...
  */
   ...
   */
		...
		key: "textColor",
		value: function textColor(a) {
			this.override("color", a);
		}
   ...
   */
    ...
    {
		key: "bgColor",
		value: function bgColor(a) {
			this.override("background-color", a);
		}
